...
//talon
    ...
    //April Tags
    public static final Rotation3d CAMERA_ANGLE = new Rotation3d(0, 20, 0);
    public static final Pose3d[] TAGS_POSES = {new Pose3d(), new Pose3d(2, 0, 1, new Rotation3d(0, 0, Math.PI))};
