    ...
    public void execute() {
        ...
        if ((pov == 0 || pov == 45 || pov == 315) && (previousPov != 0 && previousPov != 45 && previousPov != 315)) {
            upPressed();
                ...
                && (previousPov == 0 || previousPov == 45 || previousPov == 315)) {
            upReleased();
        } else if ((pov == 180 || pov == 135 || pov == 225)
                && (previousPov != 180 && previousPov != 135 && previousPov != 225)) {
        ...
        if (pov != 0 && pov != 45 && pov != 315)
            ballSubsystem.setShooterSpeed(
                    Constants.SHOOTER_FLYWHEEL_RPM_HIGH_GOAL + (int) (mainController.getRawAxis(5) * 200));
    }
